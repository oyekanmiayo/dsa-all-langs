...
namespace Basic_Data_Structure
{
    ...
    class ListOfSuccessorsGraph<T>
    {
        ...
        //Checks if a vertex exists within a graph
        ...
        //Gets a vertex's adjacent vertices 
        public List<T> FindNeighbours(T vertex)
        {
            return this.Graph[vertex];
        }

        //Checks if an edge exist between two vertices
        ...
        {
            ListOfSuccessorsGraph<int> graph = new ListOfSuccessorsGraph<int>();
            graph.AddVertex(3);
            graph.AddVertex(10);
            graph.AddEdge(3, 20);
            graph.AddVertex(20);
